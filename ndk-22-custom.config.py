...
ABIs = [
    ...
    ABI("3", "arm64-v8a",   None, cmake_vars=dict(ENABLE_THIN_LTO='ON', ENABLE_NEON='ON', ENABLE_VFPV3='ON', ANDROID_STL='c++_static', ANDROID_GRADLE_PLUGIN_VERSION='7.2.0', GRADLE_VERSION='7.5', KOTLIN_PLUGIN_VERSION='1.5.10')),
